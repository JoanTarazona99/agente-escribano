...
# Modelo principal: qwen/qwen2.5-72b-instruct:free (MÁS estable, datos abril 2026: 34 requests exitosos)
...
OPENROUTER_MODEL = env("OPENROUTER_MODEL", default="qwen/qwen2.5-72b-instruct:free")
